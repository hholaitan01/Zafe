// "Your money is safe" — an immersive emerald vault moment (this is a
// high-emotion confirmation), green + white to match the app. Hooks unchanged:
// data-bind amount/escrowId, data-nav timeline.
export const html = `<div style="width:100%; min-height:100dvh; overflow:hidden; position:relative; background:radial-gradient(120% 80% at 50% 10%, #0b5138 0%, #063d2a 52%, #04241a 100%); color:#fff;">
          ...
          <div style="position:absolute; inset:0; display:flex; flex-direction:column; align-items:center; justify-content:center; padding:0 34px; text-align:center;">
            <div style="position:relative; width:140px; height:140px; animation:floaty 5.5s ease-in-out infinite;">
              <div style="position:absolute; inset:0; border-radius:50%; background:radial-gradient(circle at 35% 28%, #0b6b4a 0%, #04241a 70%); box-shadow:0 30px 70px -14px rgba(0,40,20,.6), inset 0 0 0 1px rgba(5,150,105,.35);"></div>
              <div style="position:absolute; inset:-3px; border-radius:50%; border:3px solid transparent; border-top-color:#059669; border-right-color:#059669; box-shadow:0 0 22px rgba(5,150,105,.6);"></div>
              <svg width="52" height="52" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2" style="position:absolute; top:44px; left:44px;"><rect x="4" y="10" width="16" height="10" rx="2"/><path d="M8 10V7a4 4 0 0 1 8 0v3" stroke-linecap="round"/></svg>
            </div>
            ...
            <p style="margin-top:14px; font-size:15px; color:#a8e6c8; line-height:1.55; max-width:32ch;">The seller can now ship. Your money is released only when <b style="color:#fff;">you</b> confirm you got the item.</p>
