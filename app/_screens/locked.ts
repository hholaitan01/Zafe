...
export const html = `<div style="width:100%; min-height:100dvh; overflow:hidden; position:relative; background:radial-gradient(120% 80% at 50% 10%, #14304A 0%, #0F172A 52%, #0A1524 100%); color:#fff;">
          ...
          <div style="position:absolute; inset:0; display:flex; flex-direction:column; align-items:center; justify-content:center; padding:0 34px; text-align:center;">
            <div style="position:relative; width:140px; height:140px; animation:floaty 5.5s ease-in-out infinite;">
              <div style="position:absolute; inset:0; border-radius:50%; background:radial-gradient(circle at 35% 28%, #1e405f 0%, #0F172A 70%); box-shadow:0 30px 70px -14px rgba(0,0,0,.6), inset 0 0 0 1px rgba(16,185,129,.3);"></div>
              <div style="position:absolute; inset:-3px; border-radius:50%; border:3px solid transparent; border-top-color:#10B981; border-right-color:#10B981; box-shadow:0 0 22px rgba(16,185,129,.5);"></div>
              <svg width="52" height="52" viewBox="0 0 24 24" fill="none" stroke="#6EE7B7" stroke-width="2" style="position:absolute; top:44px; left:44px;"><rect x="4" y="10" width="16" height="10" rx="2"/><path d="M8 10V7a4 4 0 0 1 8 0v3" stroke-linecap="round"/></svg>
            </div>
            ...
            <div style="margin-top:22px; display:inline-flex; align-items:center; gap:8px; padding:8px 15px; border-radius:999px; background:rgba(16,185,129,.12); border:1px solid rgba(16,185,129,.26); font-size:12.5px; font-weight:600; color:#6EE7B7;"><span style="width:7px; height:7px; border-radius:50%; background:#10B981;"></span><span data-bind="escrowId">Escrow held safe</span></div>
