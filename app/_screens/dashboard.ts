// Dashboard — leads with money protected (vault hero), then a proactive AI
// insight and a KPI row (trust / successful / active), then active escrows.
// Content modelled on the Claude Design dashboard, built for mobile in the
// navy/emerald language. Hooks: data-nav/action/bind/html/photo, .ring/.score-num.
export const html = `<div class="fscroll" style="width:100%; min-height:100dvh; position:relative; background:#F8FAFC; color:#0F172A; padding-bottom:112px;">
          ...
          <div style="margin:18px 20px 0; border-radius:24px; padding:22px; background:radial-gradient(120% 130% at 85% 0%, #14304A 0%, #0F172A 55%); position:relative; overflow:hidden; box-shadow:0 24px 48px -22px rgba(15,23,42,.5);">
            ...
            <div style="position:relative;">
              <div style="display:inline-flex; align-items:center; gap:7px; font-size:11.5px; font-weight:600; letter-spacing:.04em; color:#6EE7B7;"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#6EE7B7" stroke-width="2"><path d="M6 10V8a6 6 0 0 1 12 0v2M5 10h14a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1v-8a1 1 0 0 1 1-1Z"/></svg>PROTECTED IN ESCROW</div>
              <div data-bind="heldAmount" style="margin-top:12px; font-size:44px; font-weight:700; letter-spacing:-.04em; line-height:1; color:#fff; font-variant-numeric:tabular-nums;">₦0</div>
              <div data-bind="heldSub" style="margin-top:8px; font-size:13px; color:#93A4BC; line-height:1.5; max-width:32ch;">Nothing in escrow yet. Start a protected deal and your money stays locked until you confirm.</div>
            </div>
          </div>
          <!-- KPI row -->
          <div style="margin:12px 20px 0; display:grid; grid-template-columns:repeat(3,1fr); gap:10px;">
            <div class="navbtn" data-nav="profile" style="border-radius:16px; background:#fff; border:1px solid #E6EAF0; box-shadow:0 1px 2px rgba(15,23,42,.05); padding:13px 14px;"><div style="font-size:10.5px; font-weight:600; letter-spacing:.05em; text-transform:uppercase; color:#94A3B8;">Trust</div><div class="score-num" style="font-size:24px; font-weight:700; color:#059669; margin-top:4px; letter-spacing:-.02em;">—</div></div>
            <div class="navbtn" data-nav="history" style="border-radius:16px; background:#fff; border:1px solid #E6EAF0; box-shadow:0 1px 2px rgba(15,23,42,.05); padding:13px 14px;"><div style="font-size:10.5px; font-weight:600; letter-spacing:.05em; text-transform:uppercase; color:#94A3B8;">Successful</div><div data-bind="kpiSuccess" style="font-size:24px; font-weight:700; color:#0F172A; margin-top:4px; letter-spacing:-.02em;">0</div></div>
            <div class="navbtn" data-nav="history" style="border-radius:16px; background:#fff; border:1px solid #E6EAF0; box-shadow:0 1px 2px rgba(15,23,42,.05); padding:13px 14px;"><div style="font-size:10.5px; font-weight:600; letter-spacing:.05em; text-transform:uppercase; color:#94A3B8;">Active</div><div data-bind="kpiActive" style="font-size:24px; font-weight:700; color:#0F172A; margin-top:4px; letter-spacing:-.02em;">0</div></div>
          </div>
          <!-- proactive AI insight (only when there's something to act on) -->
          <div data-html="aiBanner" style="margin:0 20px;"></div>
          <!-- actions -->
