...
export const html = `<div data-tabs style="width:366px; height:820px; border-radius:42px; overflow:hidden; position:relative; background:#0B0B0D;">
          ...
          <div id="pane-sellcam" data-pane style="position:absolute; inset:0; z-index:1;">
            ...
            <!-- framing brackets -->
            <div style="position:absolute; top:150px; left:44px; width:30px; height:30px; border-top:3px solid rgba(255,255,255,.7); border-left:3px solid rgba(255,255,255,.7);"></div>
            <div style="position:absolute; top:150px; right:44px; width:30px; height:30px; border-top:3px solid rgba(255,255,255,.7); border-right:3px solid rgba(255,255,255,.7);"></div>
            <div style="position:absolute; bottom:250px; left:44px; width:30px; height:30px; border-bottom:3px solid rgba(255,255,255,.7); border-left:3px solid rgba(255,255,255,.7);"></div>
            <div style="position:absolute; bottom:250px; right:44px; width:30px; height:30px; border-bottom:3px solid rgba(255,255,255,.7); border-right:3px solid rgba(255,255,255,.7);"></div>
