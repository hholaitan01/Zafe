// Notifications — a real feed from the user's deal timeline. Rebuilt light (v2).
// Items generated in notifications/page.tsx. Hooks unchanged: data-html items.
