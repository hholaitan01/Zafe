...
export const html = `<div class="fscroll" style="width:366px; height:820px; border-radius:42px; overflow-y:auto; overflow-x:hidden; position:relative; background:#0B0B0D;">
          ...
          <div style="margin:12px 22px 0; border-radius:18px; background:#141416; border:1px solid #202024; padding:16px;">
            ...
            <label style="display:block; margin-top:14px; font-size:12px; font-weight:600; color:#9A9AA0;">Other names</label>
            <input data-field="otherNames" placeholder="Optional" style="margin-top:6px; width:100%; box-sizing:border-box; height:50px; border-radius:12px; background:#1A1A1D; border:1px solid #26262b; padding:0 14px; font-size:15px; color:#fff; outline:none;"/>
            <label style="display:block; margin-top:14px; font-size:12px; font-weight:600; color:#9A9AA0;">Last name</label>
            <input data-field="lastName" placeholder="Last name" style="margin-top:6px; width:100%; box-sizing:border-box; height:50px; border-radius:12px; background:#1A1A1D; border:1px solid #26262b; padding:0 14px; font-size:15px; color:#fff; outline:none;"/>
            <div class="navbtn" data-action="saveNames" style="margin-top:16px; height:48px; border-radius:12px; background:#E4144F; display:flex; align-items:center; justify-content:center; font-weight:700; font-size:14.5px;"><span data-bind="saveLabel">Save changes</span></div>
          </div>
          <!-- account -->
