...
export const html = `<div class="fscroll" style="width:366px; height:820px; border-radius:42px; overflow-y:auto; overflow-x:hidden; position:relative; background:#0B0B0D;">
          ...
          <div class="navbtn" data-nav="selling" style="margin:12px 22px 0; border-radius:18px; background:#141416; border:1px solid #202024; padding:16px; display:flex; align-items:center; gap:13px;"><div style="width:42px; height:42px; border-radius:12px; background:rgba(228,20,79,.14); display:flex; align-items:center; justify-content:center;"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#E4144F" stroke-width="1.9"><path d="M3 21h18M5 21V10l7-5 7 5v11M9 21v-6h6v6"/></svg></div><div style="flex:1;"><div style="font-size:14px; font-weight:700;">Sell on TrustFlow</div><div style="font-size:12.5px; color:#9A9AA0; margin-top:2px;">Verify to receive payouts &amp; manage your sales</div></div><svg width="18" height="18" viewBox="0 0 24 24" stroke="#6d6d74" stroke-width="2" fill="none"><path d="M9 18l6-6-6-6"/></svg></div>
