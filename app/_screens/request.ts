...
export const html = `<div class="fscroll" style="width:366px; height:820px; border-radius:42px; overflow-y:auto; overflow-x:hidden; position:relative; background:#0B0B0D;">
          ...
          <div style="padding:6px 22px 0;">
            <p style="font-size:13.5px; color:#9A9AA0; line-height:1.5;">Ask a buyer to pay into escrow. Their money is held safely, and you get paid the moment they confirm they received the item.</p>
