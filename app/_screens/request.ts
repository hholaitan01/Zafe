...
export const html = `<div class="fscroll" style="width:366px; height:820px; border-radius:42px; overflow-y:auto; overflow-x:hidden; position:relative; background:#0B0B0D;">
          ...
          <div style="padding:6px 22px 0;">
            ...
            <div style="margin-top:16px;">
              ...
              <input data-field="buyer" placeholder="+234 803 555 0142 or buyer@email.com" style="margin-top:8px; width:100%; box-sizing:border-box; height:56px; border-radius:14px; background:#1A1A1D; border:1px solid #26262b; padding:0 16px; font-size:15px; color:#fff; outline:none;"/>
            </div>
            <p data-bind="err" style="margin-top:16px; font-size:13px; color:#ff6b81; line-height:1.4;"></p>
            <div class="navbtn" data-action="request" style="margin:12px 0 24px; height:56px; border-radius:14px; background:#E4144F; display:flex; align-items:center; justify-content:center; gap:10px; font-weight:700; font-size:16px;"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2.2"><path d="M22 2L11 13M22 2l-7 20-4-9-9-4 20-7z" stroke-linecap="round" stroke-linejoin="round"/></svg>Send payment request</div>
          </div>
        </div>`;
