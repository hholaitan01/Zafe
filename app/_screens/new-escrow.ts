...
export const html = `<div class="fscroll" style="width:366px; height:820px; border-radius:42px; overflow-y:auto; overflow-x:hidden; position:relative; background:#0B0B0D;">
          ...
          <div style="padding:6px 22px 0;">
            ...
            <div style="margin-top:22px;">
              ...
              <div style="margin-top:8px; height:70px; border-radius:16px; background:#1A1A1D; border:1px solid #26262b; display:flex; align-items:center; padding:0 18px; gap:6px;"><span style="font-size:30px; font-weight:800; color:#6d6d74;">₦</span><input data-field="amount" inputmode="numeric" value="450000" style="flex:1; min-width:0; background:transparent; border:none; outline:none; color:#fff; font-size:30px; font-weight:800; letter-spacing:-.02em;"/></div>
            </div>
            <div style="margin-top:16px;">
              <label style="font-size:12px; font-weight:600; color:#9A9AA0;">Item description</label>
              <input data-field="title" value="MacBook Air M2, Space Grey, 256GB" style="margin-top:8px; width:100%; box-sizing:border-box; height:56px; border-radius:14px; background:#1A1A1D; border:1px solid #26262b; padding:0 16px; font-size:15px; color:#fff; outline:none;"/>
            </div>
            <div style="margin-top:16px;">
              <label style="font-size:12px; font-weight:600; color:#9A9AA0;">Seller's phone or email</label>
              <input data-field="seller" value="+234 803 555 0142" style="margin-top:8px; width:100%; box-sizing:border-box; height:56px; border-radius:14px; background:#1A1A1D; border:1px solid #26262b; padding:0 16px; font-size:15px; color:#fff; outline:none;"/>
            </div>
            ...
            <div style="margin-top:22px;">
              ...
              <textarea data-field="chat" style="width:100%; box-sizing:border-box; border-radius:18px; background:#120a14; border:1.5px dashed rgba(124,58,237,.5); padding:16px; min-height:150px; font-size:12.5px; color:#cfcfd6; line-height:1.55; outline:none; resize:vertical; font-family:inherit;">Seller: This is the last one, pay into my personal account now before someone else buys it.
You: Can we do a quick video call to confirm it's real?
Seller: No time abeg, just send the money sharp sharp — trust me.</textarea>
