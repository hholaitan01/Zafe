...
const THEME: Record<TrustVerdict, { ring: string; fg: string; tint: string; bd: string; label: string; safe: boolean }> = {
  ...
  caution: { ring: "#94A3B8", fg: "#475569", tint: "#F1F5F9", bd: "#E2E8F0", label: "Caution", safe: false },
  risky: { ring: "#94A3B8", fg: "#334155", tint: "#F1F5F9", bd: "#E2E8F0", label: "High risk", safe: false },
};
